...
export const NASDAQ_LARGE_CAPS: Ticker[] = [
    {
        "name": "Tesla, Inc.",
        "symbol": "TSLA"
    },
...
export const NASDAQ_MID_CAPS: Ticker[] = [
    {
    ...
    {
        "name": "Liberty Media Corporation - Series C Liberty Live",
        "symbol": "LLYVK"
    },
    {
    ...
    {
        "name": "AGNC Investment Corp. - Depositary Shares Each Representing a 1/1,000th Interest in a Share of 7.00% Series C Fixed-To-Floating Rate Cumulative Redeemable Prefe",
        "symbol": "AGNCN"
    },
    {
        "name": "Liberty Global Ltd.",
